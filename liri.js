...
function execute(command, searchItem) {
    switch (command) {
        ...
        default:
            console.log("I do not understand. Please use 'spotify-this-song', 'concert-this', 'movie-this', or 'do-what-it-says' for information requests.");
    ...
    .catch(function(error) {
        axios.get("http://www.omdbapi.com/?t=Mr.+Nobody&y=&plot=short&apikey=trilogy").then(
            function(response) {
                ...
                var text = "Hmmm...that does not exist. May I suggest: " + "Mr. Nobody" + "\n" +
                    "IMBD Rating of the movie: " + response.data.imdbRating + "\n" +
                    "Rotton Tomatoes Rating of the movie: " + response.data.Ratings[1].Value + "\n" +
